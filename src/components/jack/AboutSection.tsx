  ...
  return (
    ...
    >
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="absolute top-[4%] left-[1%] sm:left-[2%] md:left-[4%] w-[60px] sm:w-[120px] md:w-[170px] lg:w-[210px]"
      >
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="absolute bottom-[8%] left-[3%] sm:left-[6%] md:left-[10%] w-[50px] sm:w-[100px] md:w-[140px] lg:w-[180px]"
      >
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="absolute top-[4%] right-[1%] sm:right-[2%] md:right-[4%] w-[60px] sm:w-[120px] md:w-[170px] lg:w-[210px]"
      >
      ...
      <FadeIn
        ...
        y={0}
        duration={0.9}
        className="absolute bottom-[8%] right-[3%] sm:right-[6%] md:right-[10%] w-[65px] sm:w-[130px] md:w-[180px] lg:w-[220px]"
      >
